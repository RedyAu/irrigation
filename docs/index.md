...
Last updated: ✅ `2026-05-10T06:43:26.716393`
...
Over the last week: `3.500 mm` rainfall, `25.06 °C` average daily maximal temperature.

Total amount of water needed: `29.70 mm`

### [Watering needed over the last week](lastweek.txt) - `26.20 mm`

---

## Today's values

Today's forecast: `0.09000 mm` rainfall, `23.10 °C` maximum temperature.

Total amount of water needed: `3.647 mm`

### [Watering needed today](today.txt) - `3.557 mm`
