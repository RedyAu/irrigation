...
Last updated: ✅ `2026-04-30T06:40:00.386572`
...
Over the last week: `0.000 mm` rainfall, `19.80 °C` average daily maximal temperature.

Total amount of water needed: `20.18 mm`

### [Watering needed over the last week](lastweek.txt) - `20.18 mm`

---

## Today's values

Today's forecast: `0.01000 mm` rainfall, `13.70 °C` maximum temperature.
