...
Last updated: ✅ `2026-06-26T06:53:39.717312`
...
Over the last week: `0.000 mm` rainfall, `33.53 °C` average daily maximal temperature.

Total amount of water needed: `51.76 mm`

### [Watering needed over the last week](lastweek.txt) - `51.76 mm`

---

## Today's values

Today's forecast: `0.000 mm` rainfall, `36.80 °C` maximum temperature.

Total amount of water needed: `8.943 mm`
